...
public class ReviewService {
    ...
    public String getRatingStars(Double averageRating) {
        ...
        for (int i = 0; i < full; i++) sb.append("<i class='fa fa-star'></i>");
        if (half) sb.append("<i class='fa fa-star-half-o'></i>");
        for (int i = full + (half ? 1 : 0); i < 5; i++) sb.append("<i class='fa fa-star-o'></i>");
